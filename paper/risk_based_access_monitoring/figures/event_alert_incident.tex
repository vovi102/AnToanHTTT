% Phần mở rộng context-risk: quy tắc build_incidents trong src/rbac_guard/context.py.
\begin{tikzpicture}[
  font=\footnotesize,
  >=Latex,
  ...
  \draw[flow] (events) -- node[above, align=center] {luật; ngữ cảnh\\khi được bật} (alerts);
