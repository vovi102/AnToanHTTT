\begin{table*}[t]
  \centering
  \small
  \caption{Artifact incident của phần mở rộng context-risk, tái sinh từ \texttt{artifacts/cp3-context/incidents.json}. Thời gian là hai mốc \texttt{start\_time} và \texttt{end\_time} do chương trình ghi nhận, không phải timeline chi tiết.}
