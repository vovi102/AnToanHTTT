...
\begin{figure}[htbp]
\centering
\resizebox{\textwidth}{!}{\input{figures/trust-boundaries}}
...
Mỗi ranh giới có một tiêu chí quan sát tương ứng. Với ranh giới HTTP, request
trực tiếp tới URL phê duyệt phải nhận HTTP 403 trong khi giao dịch vẫn pending.
Với ranh giới parser, header thiếu, timestamp sai hoặc loại file không hỗ trợ
phải được cô lập theo dòng hoặc làm lần chạy kết thúc bằng thông báo kiểm soát.
Với ranh giới lưu trữ, foreign key, transaction rollback và phép ghi artifact
qua file tạm rồi replace là các cơ chế cần quan sát được.
...
hình đe dọa thành điều kiện đánh giá; chúng không loại bỏ rủi ro dư đã nêu trong
